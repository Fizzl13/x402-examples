...
```
BTC: CAUTION
Crowded long (funding positive across venues, leveraged funds heavily net long) while price is below cloud on 4h, below cloud on 1d: longs are leaning against a bearish trend.

Funding     avg +0.0135% (binance +0.0120%, bybit +0.0150%); withheld: okx  [live, next funding …]
